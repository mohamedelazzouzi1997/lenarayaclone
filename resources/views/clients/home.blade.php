        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 z-10">
            <div class="text-center">
                ...
                <div data-aos="fade-down" id="about" class="text-2xl fw-josef text-white text-start font-extrabold">
                    Le Blokk est un restaurant bar international, marocain et japonais à thème, musical Live show qui vous
            ...
            <div class="">
                ...
                <p class="text-2xl font-semibold text-white text-center mt-5">
                    <i class="fa-solid fa-location-dot text-orange-300"></i> Route des Jardins de la Palmeraie, Marrakech,
                    Maroc
                </p>
            </div>
        </div>

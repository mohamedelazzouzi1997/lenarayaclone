    ...
    <div class="grid grid-cols-1 md:grid-cols-2">
        <div class="space-x-5 text-center md:text-start ">
            ...
            <a href="https://www.instagram.com/narayamarrakech/"><i
                    class="fa-brands text-fuchsia-900 text-2xl hover:text-white fa-instagram"></i></a>
            <a href="https://www.youtube.com/channel/UCzhdfD_1F5h0yM1Thdt_M4A"><i
                    class="fa-brands text-fuchsia-900 text-2xl hover:text-white fa-youtube"></i></a>
            <a
                href="https://www.tripadvisor.com/Restaurant_Review-g293734-d19003850-Reviews-Le_Naraya-Marrakech_Marrakech_Safi.html">

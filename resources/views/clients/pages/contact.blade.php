        ...
        <div class="text-center">
            ...
            <div class="text-white text-center mx-auto">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <form data-aos="fade-down" action="" class="space-y-5 font-sans">
                        ...
                        <input placeholder="Téléphone(*)"
                            class="bg-black w-full border border-orange-300 px-3 py-3 text-white" type="text">
                        <h2 class="uppercase my-1 mt-3 text-start text-5xl font-sans text-orange-300">
                            Message
                        </h2>
                        <textarea class="bg-black w-full border border-orange-300 px-3 py-3 text-white w-full" name="" id=""
